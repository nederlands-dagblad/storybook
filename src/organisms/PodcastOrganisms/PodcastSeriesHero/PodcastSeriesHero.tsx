...
export const PodcastSeriesHero: React.FC<PodcastSeriesHeroProps> = ({
    ...
    return (
        <div className="flex flex-col sm:flex-row gap-xs md:gap-l mt-m md:mt-xl">
            ...
            <div className="flex flex-col gap-l xl:gap-xl justify-center sm:flex-1 sm:min-w-0">
                <div className="flex flex-col gap-s">
                    ...
                    {description && (
                        <p className={"text-body-light text-text-default"} dangerouslySetInnerHTML={{__html: description}} />
                    )}
                </div>
